...
describe('UserResolver', () => {
    ...
    const mockJwtService = {
        // Mock the necessary methods of JwtService
        sign: jest.fn(),
        verify: jest.fn(),
    };
    ...
    describe('changePassword', () => {
        it('should change user password', async () => {
            ...
            }; // specify your change password DTO
            const user: UserEntity = { id: '1', email: 'test@example.com' } as UserEntity;
            const response = new ResponseDto(200, 'SUCCESS', user, null);
    ...
    describe('userStatistics', () => {
        it('should return user statistics', async () => {
            const response = new ResponseDto(200, 'SUCCESS', 10, null); // Example response with a number
