    ...
    <div className={styles["wrapper"]}>
      <div className={styles["body-container"]}>
        ...
        <div className={styles["title-container"]}>
          <Title level={4} style={{ color: COLOR.PRIMARY, marginTop: "10rem" }}>
        ...
        <div
          ...
          style={{ marginTop: "6rem", border: "2px solid #e9ecef" }}
        >
          <img
        ...
        <div className={styles["support-container"]}>
          ...
          <Flex
            justify="center"
            align="center"
            style={{ margin: "4.5rem auto 0 auto", width: "74%" }}
          >
        ...
        <div className={styles["team-container"]}>
          ...
          >
            <div className={styles["team-card"]}>
              ...
              <Paragraph>
                Tung is a software engineer with a passion for creating
                innovative and efficient solutions to complex problem.
              </Paragraph>
              <img
