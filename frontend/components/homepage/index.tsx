    ...
    <div className={styles['wrapper']}>
      ...
      <div className={styles['body-container']}>
        ...
        <div className={styles['support-container']}>
          ...
          <Flex justify="center" align="center" style={{ margin: "4.5rem auto 0 auto", width: "74%" }}>
            <div className={styles['team-card']}>
              <img style={{ width: "11%" }} className={styles['icon-support']} src={PhoneIcon.src} alt="tung" />
              <Title level={5} style={{ color: COLOR.TEXT, marginTop: "1.5rem" }}>Phone support</Title>
              <Paragraph style={{ margin: 0 }}>0602249017</Paragraph>
            </div>

            <div className={styles['team-card']}>
              <img style={{ width: "12%" }} className={styles['icon-support']} src={EmailIcon.src} alt="tung" />
              <Title level={5} style={{ color: COLOR.TEXT, marginTop: "1.5rem" }}>Email support</Title>
              <Paragraph style={{ margin: 0 }}>support.srouting@gmail.com</Paragraph>
            </div>

            <div className={styles['team-card']}>
              <img style={{ width: "9%" }} className={styles['icon-support']} src={BuildingIcon.src} alt="tung" />
              <Title level={5} style={{ color: COLOR.TEXT, marginTop: "1.5rem" }}>Meet at the office</Title>
              <Paragraph style={{ margin: 0 }}>1234 Main Street, Suite 567</Paragraph>
            </div>
          </Flex>
        ...
        <div className={styles['team-container']}>
          ...
          <Flex justify="center" align="flex-start" style={{ marginTop: "4.5rem", gap: "8rem" }}>
            ...
            <div className={styles['team-card']}>
              ...
              <Title level={5} style={{ marginTop: "2rem", color: COLOR.TEXT }}>Le Huynh Phuong Tung</Title>
              <Paragraph style={{ marginTop: "0", fontSize: "1rem", color: "grey" }}>Lead Developer</Paragraph>
              <Paragraph>Tung is a software engineer with a passion for creating innovative and efficient solutions to complex problem.</Paragraph>
              <img style={{ margin: "1.5rem auto 0 auto" }} width={190} alt='credit_cert' src={Social.src} />
            </div>

            <div className={styles['team-card']}>
              <img className={styles['avatar']} src={Huy.src} alt="tung" />
              <Title level={5} style={{ marginTop: "2rem", color: COLOR.TEXT }}>Tran Dam Gia Huy</Title>
              <Paragraph style={{ marginTop: "0", fontSize: "1rem", color: "grey" }}>Fullstack Website Developer</Paragraph>
              <Paragraph>Huy is a full-stack website developer skilled in building both intuitive front-end interfaces and scalable back-end solutions.</Paragraph>
              <img style={{ margin: "1.5rem auto 0 auto" }} width={190} alt='credit_cert' src={Social.src} />
            </div>
