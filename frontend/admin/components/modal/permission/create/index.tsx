...
import { ADD_PERMISSION } from "@/apollo/mutations/permission";
...
const CreatePermissionModal: React.FC<CustomModalProps> = ({
  open,
  onClose,
}) => {
  // Validate Yup
  ...
  const [addPermissionMutation] = useMutation(ADD_PERMISSION, {
    onCompleted: async () => {
